#==================================
#Obs: Para o input, digite um sinal (+ ou -) seguido de um numero ate 5 dígitos, um espaço e mais outro sinal seguido de outro num de 5 dígitos
#Exemplo: +2416 -12
#=================================
...
#cria um vetor que armazena as potencias de 10 ate 10^9 pois o resultado pode ser até 10 dígitos 
